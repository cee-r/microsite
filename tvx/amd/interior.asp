...
<head>
  ...
  <script src="js/jquery-1.10.2.js"></script> <!-- Fade function errors - need review -->
...
<body class="subpage">
  ...
  <div class="container-fluid">
    ...
    <!-- ========== Shell Starts ========== -->
    <div class="container">
      <div class="warning-box-wrapper container-fluid">
        <div class="warning-box col-lg-8 col-md-10 col-sm-12 col-xs-12">
          <div class="for-cell">
            <p class="blue-text"><img src="img/question-icon.png" width="99" height="99" class="smiley"><br><strong>Why am I seeing this message?</strong></p>
            <p>Because screenshots are designed to view only on a desktop or a laptop.</p>
          </div>
          <div class="for-both"><strong>Screenshots are designed to view only on a desktop or a laptop.</strong></div>
          <div class="for-desktop">
            <p class="blue-text"><strong>In order to remove this message box please check the following settings.</strong>
              <p/>
              <p class="blue-text"><strong>Solution 1: Maximize the browser window.</strong></p>
              <p>If your browser window looks smaller than your entire screen size then please click the button that is either on the left or the right of your browser top bar.<br><img src="img/browser-pc.png" width="259" height="85"><img src="img/browser-mac.png"
                  width="259" height="85"></p>
              <p class="blue-text"><strong>Solution 2: Reset browser zoom settings to 100%</strong></p>
              <p><strong>For PC:</strong> Hold down the �Ctrl� key and press �0� (zero) to reset to 100%<br><strong>For Mac: </strong>Hold down the �Command� key and press �0� (zero) to reset to 100%</p>
              <p>If the above mentioned solutions fail to remove this message box, this means computer�s resolution is smaller in width than 1230 pixels. Please change your screen resolution or contact your IT professional for further assistance.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container top">
        <div class="row">
          <div class="col-3 logo">
            ...
            <span>Tagline</span>-->
            <a href="default.asp"><img src="img/logo.png" alt="Logo" /></a>
          </div>
          <div class="col-9 nav">
            <!-- // NAV  -->
            ...
            <nav>
                <div id="primary-nav" class="row">
                  <ul>
                    ...
                    <li><a href="javascript:void(0);" class="current-pg">Office Info</a>
                      <ul>
                        <li><a href="javascript:void(0);">Elit Magna Enim</a></li>
                        <li><a href="javascript:void(0);">Dolor Sit Amet</a></li>
                        <li><a href="javascript:void(0);">Ac in Vehicula</a></li>
                    ...
                    <li><a href="javascript:void(0);">Fun Stuff</a></li>
                    <!--<li><a href="javascript:void(0);">Contact Us</a></li>
                    <li class="last"><a href="javascript:void(0);">Patient Login</a></li> -->
                  </ul>
                </div>
            </nav>
          </div>
